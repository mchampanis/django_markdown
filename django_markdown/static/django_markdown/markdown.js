...
miu = (function($){
    ...
    var settings = {
        ...
        markupSet: [
            ...
            {name:'Link', key:'L', openWith:'[', closeWith:']([![Link:!:http://]!] "[![Title]!]")', placeHolder:'Your text to link here...', className: 'miu-icon miu-icon-link' },
            {name:'Email', key:'E', openWith:'[', closeWith:']([![Email address:!:mailto:]!] "")', placeHolder:'Email address or person\'s name', className: 'miu-icon miu-icon-email' },
            {separator:'---------------'},
